...
|----------|-------|-------|-------|------|
| `#profileArea` | intentional | — | 4 | profile.css + ps-ui-unified .pid bridge; handwriting profile (not psYou) |
...
| `.hidden` | intentional | — | 3 | utility class across bundles |
