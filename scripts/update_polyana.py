...
S = requests.Session()
S.headers.update({
    "User-Agent": "Mozilla/5.0 (compatible; PokerSwipeSync/1.4; +https://github.com/vlxax/poker-swipe)",
...
def meaningful_tournament(title: str | None, club: str, address: str = "") -> str | None:
    ...
    bad = {
        ...
        "покерненаденьгивмоскве", "визбранное", "добавитьвизбранное", "избранное", "следующаяигра", "следующая игра", "ближайшаяигра", "ближайшая игра"
    }
    if norm(t) in bad:
        return None
