...
export function sourceModeLabel(v){const known={callpush:'CALL / PUSH',vs1r:'VS 1 RAISER',vssqueeze:'VS SQUEEZE',vs1r1c:'VS RAISE + CALL',vs3bet:'VS 3BET',vs2r:'VS 2 RAISERS',sbvsbb:'SB VS BB',vs1rshort:'VS SHORT OPEN',vs4bet:'VS 4BET',vslimp:'VS LIMP'};return known[v]||v||'SOURCE';}
