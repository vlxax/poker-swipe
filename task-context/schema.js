...
const COPY_PHRASES = [
  [/price defence/gi, 'защита по цене'],
  [/river-size/gi, 'размер на ривере'],
  [/ривер-size/gi, 'размер на ривере'],
  [/required equity/gi, 'нужное эквити'],
  [/ante defence/gi, 'защита при анте'],
  [/float with backdoor/gi, 'флоат с бэкдором'],
  [/clean line value/gi, 'чистая линия вэлью'],
  [/clean line/gi, 'чистая линия'],
  [/c-bet TPTK/gi, 'с-бет топ-пара-топ-кикер'],
  [/river TPTK/gi, 'ривер топ-пара-топ-кикер'],
  [/paired board/gi, 'спаренная доска'],
  [/overpair/gi, 'оверпара'],
  [/nut straight/gi, 'натс-стрит'],
  [/triple barrel/gi, 'тройной баррель'],
  [/second pair/gi, 'вторая пара'],
  [/middle pair/gi, 'средняя пара'],
  [/check behind/gi, 'чек бихайнд'],
  [/vs donk/gi, 'против донка'],
  [/vs agro/gi, 'против агро-рега'],
  [/3-max/gi, '3-макс'],
  [/ITM fold/gi, 'ITM-фолд'],
  [/river two pair/gi, 'ривер две пары'],
  [/deep turn two pair/gi, 'глубокий тёрн две пары'],
  ...
  [/батон(?!н)/gi, 'баттон'],
  [/chipEV/gi, 'чип-EV'],
  [/credibility/gi, 'правдоподобность'],
  [/credible/gi, 'правдоподобная'],
  [/TPTK/gi, 'топ-пара-топ-кикер'],
  [/OOP/gi, 'вне позиции'],
  [/limper/gi, 'лимпер'],
  [/triple /gi, 'тройной '],
  [/\biso\b/gi, 'изолейт'],
