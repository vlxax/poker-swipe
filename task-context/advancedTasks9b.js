...
export const ADVANCED_TASKS_9B = [
  ...
  T({
    ...
    villainStack: 55, opp: 'РЕГ', board: [], pot: 8.5,
    history: [{ street: 'ПРЕФЛОП', text: 'Финальный стол. CO открыл 2.2, BTN-чиплидер трибетил 12, CO 4-бетил 28, BTN 5-бетил олл-ин 55.', pot: 8.5 }],
